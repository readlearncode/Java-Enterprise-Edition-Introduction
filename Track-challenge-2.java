...
public class Track implements Serializable {
    ...
    public Map<TrackingId, TrackingId> getTrackingIds() {
        return trackingIds;
    }

    public void setTrackingIds(Map<TrackingId, TrackingId> trackingIds) {
        this.trackingIds = trackingIds;
    }

    private Map<TrackingId, TrackingId> trackingIds = new HashMap<>();
    ...
    @PostConstruct
    public void trackingIds() {
        trackingIds = cargoRepository.findAll().stream().collect(Collectors.toMap(Cargo::getTrackingId, Cargo::getTrackingId));
    }
